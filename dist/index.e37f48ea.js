...
const showRecipe = async function() {
    try {
        ...
        if (!id) return;
        _recipeViewJsDefault.default.loading(); //modul serverga borib kelguncha loading ishlab turadi
        await _modelJs.loadRecipe(id);
        const data = _modelJs.state.recipe;
        console.log(data);
        // console.log(data);
        _recipeViewJsDefault.default.render(data); //Moduldan kelgan malumotlarni view ga junatayabmiz
    // console.log(data);
...
const searchController = async function() {
    try {
        ...
        _paginationViewJsDefault.default.render(_modelJs.state.search); //turgan pagemizni raqamini berdik
...
},{"regenerator-runtime":"dXNgZ","./model.js":"Y4A21","./views/recipeView.js":"l60JC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi"}],"dXNgZ":[function(require,module,exports) {
/**
...
const state = {
    ...
    search: {
        ...
        results: {},
        page: 1,
        perPege: _config.RES_PER_PAGE
    }
};
const loadRecipe = async function(id) {
    try {
        const data = await _helpers.getJson(_config.API_URL + id); //getJson fungsiyadidan javob kelishinin kutib turadi(fungsiyani  olib keladi)
        // console.log(data);
...
const searchResult = async function(serachKey) {
    try {
        const data = await _helpers.getJson(_config.API_URL + `?search=${serachKey}`);
        // console.log(data);
...
},{"regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config":"k5Hzs","./helpers":"hGI1E"}],"gkKU3":[function(require,module,exports) {
...
parcelHelpers.export(exports, "timiOutSec", ()=>timiOutSec
);
...
class RecipeView {
  ...
  <div class="recipe__details">
    <div class="recipe__info">
      ...
      <span class="recipe__inthis.#data recipe__info-data--minutes">${this.#data.time}</span>
  ...
  <div class="recipe__directions">
    ...
    addHandlerEvent(data) {
        ...
        ); //bu yerda data showRecipega teng
    // window.addEventListener('hashchange', showRecipe);
    // window.addEventListener('load', showRecipe);
    }
}
exports.default = new RecipeView(); //obj cha yaratib export qildik.Classlarni doim shunaqa qilib export qilishimiz kerak
...
class PaginationView {
    ...
    addHandlerEvent(handle) {
     ...
     #genereteHtml() {
        ...
        const endPage = Math.ceil(this.#data.results.length / this.#data.perPege);
        const btnPre = `
      <button class="btn--inline pagination__btn--prev" id=${currentPage - 1}>
            <svg class="search__icon">
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequirec9a9")
